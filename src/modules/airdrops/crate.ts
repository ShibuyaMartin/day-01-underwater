import { campaign_keys, claimToken, PlayCoinSound } from './loot'
...
underwater: let stageDropArea: dropArea = {
  SW: new Vector2(27, 46),
  NE: new Vector2(95, 72),
}
...
export function dropCrate(campaign: string, campaign_key: campaign_keys) {
  let crate = new Crate(
    'models/crate/crate_jelly.glb',
    'models/crate/parachute_jelly.glb',
    new Vector3(8, -10, 8),
    campaign,
    campaign_key
  )
